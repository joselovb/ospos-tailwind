...
<div class="rounded-xl border border-brand-primary-border bg-surface p-4">
    <p class="mb-3 text-sm text-text-muted"><?= lang('Config.server_notice') ?></p>

    <div class="flex gap-6">
        <div class="w-32 shrink-0 space-y-8 text-sm font-semibold text-text-default">
            <p style="min-height: 17.7em;">General Info</p>
            <p style="min-height: 12.2em;">User Setup</p>
            <p>Permissions</p>
        </div>

        <div id="issuetemplate" class="min-w-0 flex-1 font-mono text-xs text-text-default">
...
<div class="mt-3 flex items-center justify-center gap-3 text-sm">
    <a class="copy cursor-pointer text-brand-primary hover:underline" data-clipboard-action="copy" data-clipboard-target="#issuetemplate"><?= lang('Config.copy_info') ?? 'Copy Info' ?></a>
    <span class="text-text-muted">|</span>
    <a href="https://github.com/opensourcepos/opensourcepos/issues/new" target="_blank" class="text-brand-primary hover:underline"><?= lang('Config.report_an_issue') ?></a>
</div>
